...
RDEPEND="
	...
	>=gnome-base/gnome-settings-daemon-3.26.1[cups?]
	>=gnome-base/gnome-control-center-3.26.2[cups?]

	>=app-crypt/gcr-3.20.0
	>=gnome-base/nautilus-3.26.2
	>=gnome-base/gnome-keyring-3.20.0
	>=gnome-extra/evolution-data-server-3.26.4

	>=app-crypt/seahorse-3.20.0
	>=app-editors/gedit-3.22.1
	>=app-text/evince-3.26.0
	>=gnome-extra/gnome-contacts-3.26
	>=media-gfx/eog-3.26.2
	>=media-video/totem-3.26.0
	>=x11-terms/gnome-terminal-3.26.2

	>=gnome-extra/gnome-user-docs-3.26.2.1
	>=gnome-extra/yelp-3.22.0

	>=x11-themes/adwaita-icon-theme-3.26.1
